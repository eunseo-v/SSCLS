...
'''
output_config = dict(
    out = './model_pth/exp8/t7_nsnr_wfwc_ft/test_result/results.pkl'
) # 保存测试集的各类分类概率和样本名 keys:'outputs','sample_names'
eval_config = dict(
    metric_out = './model_pth/exp8/t7_nsnr_wfwc_ft/test_result',
    eval = ['top_k_accuracy', 'mean_class_accuracy', 'confusion_matrix', 't_sne_vis'],
) # train中不写test_last test_best 在test.py中测试
work_dir = './model_pth/exp8/t7_nsnr_wfwc_ft'
