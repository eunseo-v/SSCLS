...
log_level = 'INFO'
output_config = dict(
    out='./model_pth/exp3/t9nsnr_wfwc_5p_nopre/test_result/results.pkl')
eval_config = dict(
    metric_out='./model_pth/exp3/t9nsnr_wfwc_5p_nopre/test_result',
    eval=[
        'top_k_accuracy', 'mean_class_accuracy', 'confusion_matrix',
        't_sne_vis'
    ])
work_dir = './model_pth/exp3/t9nsnr_wfwc_5p_nopre'
load_from = None
