...
log_level = 'INFO'
output_config = dict(
    out='./model_pth/exp5/t9nsnr_5p_ft_lrd01/test_result/results.pkl')
eval_config = dict(
    metric_out='./model_pth/exp5/t9nsnr_5p_ft_lrd01/test_result',
    eval=[
        'top_k_accuracy', 'mean_class_accuracy', 'confusion_matrix',
        't_sne_vis'
    ])
work_dir = './model_pth/exp5/t9nsnr_5p_ft_lrd01'
